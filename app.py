...
def get_ydl_opts(tmp_path):
    opts = {
        ...
        'fragment_retries': 3,
        'socket_timeout': 30,
        # No postprocessor - skip ffmpeg conversion, use native format
    }
...
def audio():
    ...
    mime = {'mp3':'audio/mpeg','m4a':'audio/mp4','webm':'audio/webm','mp4':'audio/mp4','opus':'audio/ogg','ogg':'audio/ogg'}.get(ext,'audio/mp4')
